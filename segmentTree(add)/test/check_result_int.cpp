...
void check_result_int(vector<long long>& vec, int test_round, ostream& brute_strm, ostream& segtree_strm){
    ...
    time_t start = clock();
    size_t L = -1, R = -1;
    segmentTree<long long>* tree = new segmentTree<long long>(vec);
